...
# 水の注文量
water_demand = pd.read_csv(f"{BASE_DIR}/train_data/water_demand.csv")
# JBDカレンダー
jbd_calendar = pd.read_csv(f"{BASE_DIR}/train_data/jbd_calendar.csv")
# 社員ごとのAIC出社カレンダー
work_day = pd.read_csv(f"{BASE_DIR}/train_data/work_day.csv")
# 気象データ
weather_data = pd.read_csv(f"{BASE_DIR}/train_data/weather_data.csv")
