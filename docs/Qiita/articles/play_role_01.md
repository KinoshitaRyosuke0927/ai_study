...
![アプリのメイン画面](/docs/Qiita/image/play_role_01/image_001.png)
...
![役割ごとのフィードバック比較（上司）](/docs/Qiita/image/play_role_01/image_002.png)
*上司ロールのフィードバック：結論の明確さや判断材料の過不足を中心に指摘*

![役割ごとのフィードバック比較（初学者）](/docs/Qiita/image/play_role_01/image_003.png)
...
![過去の傾向を踏まえたフィードバック](/docs/Qiita/image/play_role_01/image_004.png)
