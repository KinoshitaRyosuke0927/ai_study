...
def build_anticipated_questions_prompt_package(review_request: dict[str, Any]) -> dict[str, Any]:
    """
    プレゼンテーション全体に対して、AI技術者・アプリケーションエンジニア視点での想定質問を生成するプロンプトパッケージを構築する
